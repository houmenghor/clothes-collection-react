...
export default function Login() {
  return (
    <>
      ...
      <div class="container-fluid login-desktop">
        {/* <img src={bg} className="card-img rounded-0 position-absolute" alt="Background" height={640} /> */}
        <div class="row login-page position-relative">
          <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 left-page ">
            <div class="image">
              <p class="title text-dark">Welcome back</p>
            </div>
          </div>
          <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 right-page">
            <div class="login-form">
              <div class="form-container">

                <form class="form">
                  <label for="" class="label-user">Email or Username</label>
                  <div class="inputForm">
                    <i class="fa-solid fa-user"></i>
                    <input type="email" class="input" placeholder="Email or Username" />
                  </div>
